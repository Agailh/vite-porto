    ...
    <div>
        ...
        <div className='md:block hidden fixed top-[25%] z-10'>
            <div className='flex flex-col'>
                ...
                <a href='#mproject' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 duration-300'>
                    <AiOutlineProject />
                </a>
                <a href='#main' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 duration-300'>
                    <BsPerson />
                </a>
                <a href='#mail' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 duration-300'>
                    <AiOutlineMail />
                </a>
            </div>
        </div>
